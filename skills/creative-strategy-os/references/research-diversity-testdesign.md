...
- **Angle:** die Verkaufstür (Pain, Mechanism, Proof, Comparison, Identity, Offer … 16er-Liste in `creative-briefing/references/field-notes.md`).
...
**Output von Phase 2–4:** Angle-Bank + Concept-Matrix + ein dokumentierter Test-Plan mit Regeln. Damit briefst du (Phase 5 via `creative-briefing`) und launchst.
