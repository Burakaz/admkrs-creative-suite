...
- [ ] Offer der Ad = Offer der LP (kein Bruch)
- [ ] gleiches Produkt/Szene wie in der Ad

## Above-the-Fold (mobil zuerst)
- [ ] Value-Prop + tappbarer CTA ohne Scrollen sichtbar
...
- [ ] spezifische Testimonials (Name/Ergebnis/Foto) nahe CTA
