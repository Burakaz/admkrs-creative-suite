...
description: >
  ...
  to adapt Meta creative to Google. Pairs with creative-briefing und creative-strategy-os.
---
...
`creative-briefing` (Hooks/Copy je Format) · `creative-strategy-os` (Cross-Channel-Diversität) · `landing-page-cro` (Final-URL/Match) · `ad-compliance-check` (Google-Policies separat prüfen).
