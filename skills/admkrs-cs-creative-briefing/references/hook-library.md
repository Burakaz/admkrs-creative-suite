...
## Hook-Kategorien (mit Fill-in-Templates)

Jede Kategorie: *wann (Awareness)* → Templates → 1 gefülltes ADMKRS-Beispiel.

### 1 · Problem / Pain
*Wann:* Problem-Aware. Person spürt den Schmerz.
- `Hör auf, [schlechte Lösung] zu benutzen, um [Problem] zu kaschieren.`
- `Stop scrolling, wenn du [Problem] hast.`
- `[Zielgruppe], hört auf, [schlechte Gewohnheit] zu machen.`
- `Tut [Problem] dir auch jeden [Zeitpunkt] weh?`
- `Mach [Aktivität] nie ohne [Lösung].`
- EN: `Stop [behaviour] to hide [problem].` · `[Audience], we gotta stop [bad habit].`
> Bsp: „Hör auf, deinen Eiskaffee mit Zucker zu retten."

### 2 · Problem → Solution Bridge
*Wann:* Problem-Aware → Solution-Aware.
- `Wie ich [Problem] endlich losgeworden bin.`
- `Der schnellste Weg zu [Ergebnis].`
- `3 Tipps gegen [Problem].`
- `[Zielgruppe], das ist deine Antwort auf [Problem].`
> Bsp: „Wie ich morgens Protein UND Koffein in einem Glas habe." *(Koffein = [Ergänzung])*

### 3 · Curiosity / Secret
*Wann:* Unaware/Problem-Aware. Pattern-Interrupt.
- `[Branche] will nicht, dass du das weißt …`
- `Das [Produkt], das sich fast verboten anfühlt.`
...
- `100 % ehrliches Review von [Produkt].`
> *ADMKRS:* nur **echte**, freigegebene Reviews 1:1. Avatar = Initiale-im-Kreis oder echtes UGC, keine erfundene KI-„Verified Customer".

### 5 · Urgency / Scarcity / FOMO
...
*Wann:* Solution-/Product-Aware, evaluiert Optionen.
- `Kauf nicht [Konkurrent]. Kauf das.`
- `Warum ich [alte Methode] aufgegeben hab.`
- `[Alt-Produkt]: [schlechter Wert]. Meins: [besserer Wert].`
- `Schluss mit Geld verschwenden für [unterlegene Option].`
> Bsp: „Café-Eiskaffee: 0g Protein. Deiner: 22g."

### 7 · Authority / Expert / Educational
*Wann:* Aufbau Vertrauen, Mid-Funnel.
- `Als [Experte] war ich geschockt, als ich lernte …`
...
- `[Zahl]. [Einheit]. Mehr nicht.` → „6 Kalorien. Süße von 50g Zucker."
- `1 [klein] = [große Zahl] [Einheit]. 0 [Negativ].` → „1 Flasche = 8 Liter. 0 Zucker."
- `[Produkt-Klassiker]. [überraschende Zahl] [Nutzen].` → „Eiskaffee. 22g Protein."
> Die Zahl muss **echt & freigegeben** sein. Krumme Zahlen stoppen besser als runde.

### 15 · Native-Format & Interface-Hijacking
...
- **DTC / E-Com (Food, Beauty, Supplement):** Indulgence-vs-Trade-off, Review, Comparison, Volume-Math, Sorten-Range, UGC-„ich hab getestet".
- **B2B / SaaS:** `Noch immer [kritische Aufgabe] mit [veraltetem Tool]?` · `Das [Tool], das [Zahl]+ [Zielgruppe] nutzen.` · `Was [High-Status-Gruppe] wirklich für [Outcome] tun.`
- **Health / Wellness:** `Wusstest du, dass [Folge] durch [Alltagsverhalten] entstehen kann?` · `Diese [Lösung] [Ergebnis] in [Zeitraum].` → *nur mit freigegebenen, rechtssicheren Claims.*

---

## Hook-Selection-Guide
Wähle die Kategorie nach:
- **Awareness:** Unaware/Problem → Problem, Story, Curiosity, Number · Solution → Mechanism, Comparison · Product → Proof, Objection, Comparison · Most-Aware → Urgency, Offer.
- **Produkt-Reife:** bewährt → Social Proof · neu/Nische → Personal Experience / Story.
- **Plattform/Format:** Reels/Stories → Story, Trend, Question, Number · Static → Number, Comparison, Pain, Proof.
- **Ziel:** Conversion → Problem/Offer · Awareness → Benefit/Identity · Edukation → List/Authority.
- **Funnel:** Top → Problem-/Curiosity-Hooks · Bottom → Product-/Offer-/Proof-Hooks.

## High-Converting-Elemente (reinbauen) vs. vermeiden
**Rein:** Spezifik (exakte Zahlen/Zeit/Preise) · Relatability (konkrete Zielgruppe + Pain) · echter Beweis · Curiosity-Gap (Wert andeuten, nicht alles verraten) · ein klarer Gedanke.
**Raus:** Generik, die auf jedes Produkt passt · Verkaufs-Ton/„salesy" · unbelegte/erfundene Claims · Hooks ohne Bezug zum Produkt · CAPS-LOCK-Wüsten & Ausrufezeichen-Spam · Generic-AI-Floskeln (siehe Banned-List in `copywriting.md`).
