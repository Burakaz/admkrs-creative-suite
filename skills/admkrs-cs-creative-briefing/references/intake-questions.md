...
## Red Flags im Brief (vor dem Schreiben ansprechen)

- **Produkt-Label statt Hook** vorgegeben → vorschlagen, die Hook-Ebene zu schärfen (Beispiel: „Protein Iced Coffee" ist kein Hook).
- **Kein Offer**, aber DR-Ziel → fehlt der stärkste CTR/CVR-Hebel; nachfragen, ob eins freigegeben werden kann.
- **Vage Zielgruppe** („alle", „jeder") → ohne Persona kein scharfer Angle; eingrenzen.
- **Claim ohne Freigabe** / erfundene Zahl im Brief → als [Ergänzung] markieren, Freigabe einholen, nicht einfach nutzen.
- **Erfundenes/KI-Testimonial** als „echt" deklariert → Glaubwürdigkeits- + Meta-Risiko, Alternative vorschlagen (echte Review als Avatar/Initiale, echtes UGC).
- **Zu viele Botschaften pro Creative** → splitten in mehrere Konzepte (eine Idee pro Creative).
- **Widersprüchliche Tonalität** (z. B. „premium & seriös" + „frech & meme-ig") → klären, welche gewinnt.
- **Format passt nicht zum Ziel** (z. B. langer VSL für kalte Reels-Audience) → Format-Empfehlung geben.

---

## So bringt man Rückfragen rüber (ADMKRS-Stil)

Kurz, direkt, gebündelt. Beispiel:

> Bevor ich texte, drei Dinge, die das Briefing schärfer machen:
> 1. Cold oder Retargeting? (ändert die Hook-Ebene)
> 2. Ist das −20 %-Offer freigegeben oder Platzhalter?
