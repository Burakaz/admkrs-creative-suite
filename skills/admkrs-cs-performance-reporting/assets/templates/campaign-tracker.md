...
## Tab 1 - Campaign Master
| Kampagne | Ziel/KPI | Struktur (ASC/ABO/CBO) | Budget/Tag | Start | Status | Notiz |
|---|---|---|---|---|---|---|

## Tab 2 - Asset-Tracker (das Herz)
| Asset-Name (`Format_Hook_Angle_Audience`) | Format/Style | Concept/Angle | Persona | Hook (A/B/C) | Creator | Spend | **Hook-Rate** | Hold | CTR(out) | CVR | CPA/ROAS | **DECISION** |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
...
## Tab 4 - Drehplan / Produktion
| Konzept | Format/Style | Creator/Asset-Quelle | Hooks (3) | Status (Brief/Draft/Review/Approved) | Due |
|---|---|---|---|---|---|

## Tab 5 - Learned-Concepts (lebt mit)
| Validierter Gewinner-Angle/Hook/Format | Evidenz (Metrik) | Für welche Persona | Datum |
|---|---|---|---|
