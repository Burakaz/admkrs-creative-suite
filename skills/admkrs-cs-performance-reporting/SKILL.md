---
name: admkrs-cs-performance-reporting
description: >
  ...
  Pairs with admkrs-cs-creative-strategy-os (Phase 6 & 9) und admkrs-cs-creative-teardown.
---

# Performance Reporting & Weekly Review

**Der Kern in einem Satz:** Ein gutes Report sagt *was wir gelernt haben und was als Nächstes passiert* — nicht „ROAS 2,4, 1,2 Mio. Impressionen". Zahlen sind die Beweise, **Learnings + Entscheidungen** sind das Produkt. Datenquelle: DatAds (+ ggf. Triple Whale/GA4). Dieser Skill schließt Phase 6 (Diagnose) und Phase 9 (Cadence) des `admkrs-cs-creative-strategy-os`.
...
`admkrs-cs-creative-strategy-os` (Phase 6 Diagnose, Phase 9 Cadence) · `admkrs-cs-creative-teardown` (Gewinner zerlegen) · `admkrs-cs-landing-page-cro` (bei CTR↑/CVR↓) · `admkrs-cs-creative-briefing` (nächste Runde aus Learnings).
