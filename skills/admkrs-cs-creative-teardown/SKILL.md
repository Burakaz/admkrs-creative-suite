...
`admkrs-cs-creative-strategy-os` (Audit/Bottleneck) · `admkrs-cs-creative-briefing` (Teardown → Briefing) · `admkrs-cs-pitch-teardown` (Teardown als Sales-Asset) · `admkrs-cs-ad-compliance-check` (bevor man fremde Hooks adaptiert).
